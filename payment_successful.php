...
while($p_price=mysqli_fetch_array($run_price)){
	...
	$insert_payments = "insert into payments (amount,customer_id,product_id) values('$amount', '$user', '$pro_id')";
}


$run_payments = mysqli_query($con, $insert_payments);
$insert_order = "insert into orders (p_id, c_id, qty) values ('$pro_id', '$c_id', '$pro_qty')";
